...
import HamburgerIcon from "@/app/_components/ui/HamburgerIcon";
import HeaderSearchInput from "@/app/_components/ui/HeaderSearchInput";
        ...
        <Container className="flex items-center justify-between gap-3">
          ...
          <ul className="hidden w-full max-w-max items-center justify-end gap-3 px-6 py-3 md:flex">
            <li className="text-lg font-semibold text-gray-500">
              <Link
                href=""
                className="px-5 py-[7.5px] hover:rounded-sm hover:bg-black hover:text-white"
              >
                Sign In
              </Link>
            </li>
            <li className="flex gap-0.5 rounded-sm bg-green-500 px-5 py-2">
              ...
              <Link className="mr-1 inline-flex" href="">
                My cart
              </Link>
